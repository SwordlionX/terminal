  ...
  return (
    <Card className="bg-[#09090b] border-zinc-800 text-zinc-100 mt-6 shadow-xl">
      ...
      <CardContent className="space-y-4 pt-5">
        <div className="p-4 rounded-lg bg-zinc-900/50 border border-zinc-800 grid grid-cols-1 md:grid-cols-3 gap-6 shadow-inner">
          <div className="space-y-1">
            <div className="text-xs text-zinc-500 uppercase tracking-wider">Hedge İşlemi (Delta Nötr İçin)</div>
            <div className="text-2xl font-bold font-mono flex items-center gap-2">
              ...
              {hedgeNeeded !== 0 && (
                <span className="text-zinc-200">{Math.abs(hedgeNeeded).toFixed(3)} <span className="text-sm font-sans text-zinc-500">ons</span></span>
              )}
            </div>
          </div>
          
          <div className="space-y-1 border-l border-zinc-800 pl-6">
            <div className="text-xs text-zinc-500 uppercase tracking-wider">Nakit Büyüklük (USD)</div>
          ...
          <div className="space-y-1 border-l border-zinc-800 pl-6">
            <div className="text-xs text-zinc-500 uppercase tracking-wider">Nakit Büyüklük (TRY)</div>
            <div className="text-xl font-bold font-mono text-zinc-300">
